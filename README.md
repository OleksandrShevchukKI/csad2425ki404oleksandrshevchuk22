...
**Task 3:** Develop a game where the Server(Arduino) and the Client(RockPaperScissors)
...
2. **Upload the Arduino Sketch:**
    ...
    - Open the Arduino IDE, navigate to `File` > `Open` and open the `RockPaperScissors/RockPaperScissorsServer/RockPaperScissorsServer.ino` file.
